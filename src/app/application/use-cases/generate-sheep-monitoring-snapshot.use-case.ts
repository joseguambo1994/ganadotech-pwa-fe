...
export class GenerateSheepMonitoringSnapshotUseCase {
  private readonly scenarios: Record<SheepCounterId, number>[] = [
    { male: 1, female: 6, newborn: 2, inHeat: 4, sick: 2 },
    { male: 1, female: 5, newborn: 2, inHeat: 3, sick: 1 },
    { male: 2, female: 6, newborn: 1, inHeat: 4, sick: 2 },
    { male: 1, female: 6, newborn: 2, inHeat: 5, sick: 2 },
  ];
